...
//Auth
$router->map("GET", "/login", ['controller' => 'Auth\AuthController', 'action' => 'login'], 'login');
...
//Admin
$router->map("GET", "/admin/dashboard", ['controller' => 'Admin\HomeController', 'action' => 'dashboard', 'middleware' => [RoleType::ADMIN->value, RoleType::ImportStaff->value]], 'admin.dashboard');
